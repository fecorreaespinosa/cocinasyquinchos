...
<head>
  ...
  <meta name="description" content="${project.title}: fotos del proyecto realizado por Quinchos &amp; Cocinas en Santiago y Viña del Mar.">
...
<body>
  ...
  <nav class="nav" aria-label="Navegación principal">
    ...
    <ul class="nav-links">
      ...
      <li><a href="index.html#antes-despues">Antes y Después</a></li>
      <li><a href="index.html#proceso">Paso a Paso</a></li>
...
${grid}
  ...
  <footer class="footer" id="nosotros">
    <div class="footer-top">
      ...
      <div class="footer-nav">
        ...
        <div class="footer-nav-col">
          <h4>Cobertura</h4>
          <ul>
            <li><a href="index.html">Región Metropolitana</a></li>
            <li><a href="index.html">V Región</a></li>
          </ul>
        </div>
      </div>
    ...
    <div class="footer-bottom">
      ...
      <p class="footer-comunas">Región Metropolitana · V Región</p>
    </div>
  </footer>
